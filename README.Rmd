...
1) Add the project to [Travis](https://www.travis-ci.com/poissonconsulting/) and in the Settings add a Cron Job to run the master branch daily if there hasn't been a build in the last 24h.
1) Add the project to [Appveyor](https://ci.appveyor.com/project/poissonconsulting).
